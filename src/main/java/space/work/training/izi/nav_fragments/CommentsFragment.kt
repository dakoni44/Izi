...
class CommentsFragment : Fragment() {
    ...
    private fun readComm() {
        postRef!!.child("Comments").child(userId).addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                modelComments.clear()
                for (snapshot in dataSnapshot.children) {
                    val modelComment = ModelComment()
                    modelComment.cid = snapshot.child("cId").getValue(String::class.java).toString()
                    ...
                    modelComment.timestamp =
                        snapshot.child("timestamp").getValue(String::class.java)
                            .toString()
                    modelComment.uId = snapshot.child("uId").getValue(String::class.java).toString()
                    modelComment.uName =
