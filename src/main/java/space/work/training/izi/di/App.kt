...
class App : Application() {
    ...
    //get in list from profiles and homeList, on 24hours home item we get to postfragment individual ( 90% 24hours deletion left ) , correct info for home list ( not grid )
